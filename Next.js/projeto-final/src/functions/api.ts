...
export function PHOTOS_GET({
  ...
  page: number
  total: number
  user: 0 | string // Quando o usuário for 0, significa que é uma requisição pública, ou seja o feed completo, quando passar uma string, significa que é o ID do usuário logado.
}) {
  return {
